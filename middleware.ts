...
export async function middleware(req: NextRequest) {
  ...
  const csp = [
    ...
    `connect-src 'self' https://api.weshoot.it https://s3.eu-west-1.amazonaws.com https://wxoodcdxscxazjkoqhsg.supabase.co https://www.facebook.com https://connect.facebook.net ${isDev ? "ws: http://localhost:*" : ""}`.trim(),
    "frame-src 'none'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
