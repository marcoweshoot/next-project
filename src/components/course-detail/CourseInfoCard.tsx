...
const CourseInfoCard: React.FC<CourseInfoCardProps> = ({ course }) => {
  ...
  const infoRows: { label: string; value: React.ReactNode }[] = [
    ...
    course.totalLessons ? { label: 'Lezioni:', value: course.totalLessons } : null,
      ...
      <CardContent className="p-8">
        {course.price != null && (
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">Accesso a vita</p>
          </div>
        )}
        ...
        {course.url ? (
          <a
            ...
            className="w-full mb-4 inline-flex items-center justify-center rounded-md bg-primary px-8 py-3 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-50 transition-colors"
