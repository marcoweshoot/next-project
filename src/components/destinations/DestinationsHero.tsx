      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            Esplora le destinazioni più affascinanti del mondo attraverso l'obiettivo della tua fotocamera. 
            Ogni viaggio è un'opportunità per catturare la bellezza unica di luoghi straordinari.
          </p>
