  ...
  return (
    <nav className="hidden lg:flex items-center flex-nowrap gap-x-1 lg:gap-x-2 xl:gap-x-3 2xl:gap-x-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          asChild
          className="bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors duration-200 text-sm xl:text-base font-semibold"
        >
